...
public class other_clothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shirtsTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Handle Shirts tab click
                Intent intent = new Intent(other_clothes.this, shirts.class);
                startActivity(intent);
            }
        });
        ...
        pantsTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(other_clothes.this, pants.class);
                startActivity(intent);
            }
        });
        ...
        shoesTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(other_clothes.this, shoes.class);
                startActivity(intent);
            }
        });
